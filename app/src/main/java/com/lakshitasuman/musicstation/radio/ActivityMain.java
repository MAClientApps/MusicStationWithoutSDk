...
import com.lakshitasuman.musicstation.radio.alarm.FragmentAlarm;
import com.lakshitasuman.musicstation.radio.alarm.TimePickerFragment;
...
import com.lakshitasuman.musicstation.radio.players.PlayStationTask;
import com.lakshitasuman.musicstation.radio.players.mpd.MPDClient;
import com.lakshitasuman.musicstation.radio.players.mpd.MPDServersRepository;
import com.lakshitasuman.musicstation.radio.players.selector.PlayerType;
import com.lakshitasuman.musicstation.radio.service.MediaSessionCallback;
import com.lakshitasuman.musicstation.radio.service.PlayerService;
...
import static com.lakshitasuman.musicstation.radio.service.MediaSessionCallback.EXTRA_STATION_UUID;
...
public class ActivityMain extends AppCompatActivity implements SearchView.OnQueryTextListener,
    ...
    public static final String ACTION_SHOW_LOADING = "com.lakshitasuman.musicstation.radio.show_loading";
    public static final String ACTION_HIDE_LOADING = "com.lakshitasuman.musicstation.radio.hide_loading";
    ...
    private com.lakshitasuman.musicstation.radio.FragmentPlayerSmall smallPlayerFragment;
    private com.lakshitasuman.musicstation.radio.FragmentPlayerFull fullPlayerFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTheme(com.lakshitasuman.musicstation.radio.Utils.getThemeResId(this));
        ...
        if (com.lakshitasuman.musicstation.radio.Utils.bottomNavigationEnabled(this)) {
        ...
        smallPlayerFragment = (com.lakshitasuman.musicstation.radio.FragmentPlayerSmall) mFragmentManager.findFragmentById(R.id.fragment_player_small);
        fullPlayerFragment = (com.lakshitasuman.musicstation.radio.FragmentPlayerFull) mFragmentManager.findFragmentById(R.id.fragment_player_full);

        if (smallPlayerFragment == null || fullPlayerFragment == null) {
            smallPlayerFragment = new com.lakshitasuman.musicstation.radio.FragmentPlayerSmall();
            fullPlayerFragment = new com.lakshitasuman.musicstation.radio.FragmentPlayerFull();
        ...
        smallPlayerFragment.setCallback(new com.lakshitasuman.musicstation.radio.FragmentPlayerSmall.Callback() {
            @Override
            public void onToggle() {
                toggleBottomSheetState();
            }
        });
        fullPlayerFragment.setTouchInterceptListener(new com.lakshitasuman.musicstation.radio.FragmentPlayerFull.TouchInterceptListener() {
            @Override
        ...
        playerBottomSheet.setBottomSheetCallback(new BottomSheetBehavior.BottomSheetCallback() {
            ...
            public void onStateChanged(@NonNull View bottomSheet, int newState) {
                ...
                if (newState == BottomSheetBehavior.STATE_EXPANDED) {
                    ...
                    smallPlayerFragment.setRole(com.lakshitasuman.musicstation.radio.FragmentPlayerSmall.Role.HEADER);
                    FragmentTransaction fragmentTransaction = mFragmentManager.beginTransaction();
                    fragmentTransaction.hide(mFragmentManager.findFragmentById(R.id.containerView));
                    fragmentTransaction.commit();
                } else if (newState == BottomSheetBehavior.STATE_COLLAPSED) {
                    appBarLayout.setExpanded(true);
                    smallPlayerFragment.setRole(com.lakshitasuman.musicstation.radio.FragmentPlayerSmall.Role.PLAYER);
    ...
    public boolean onNavigationItemSelected(MenuItem menuItem) {
        ...
        switch (selectedMenuItem) {
            case R.id.nav_item_stations:
                f = new com.lakshitasuman.musicstation.radio.FragmentTabs();
                break;
            case R.id.nav_item_starred:
                f = new com.lakshitasuman.musicstation.radio.FragmentStarred();
                break;
            case R.id.nav_item_history:
                f = new com.lakshitasuman.musicstation.radio.FragmentHistory();
                break;
        ...
        if (MediaSessionCallback.ACTION_PLAY_STATION_BY_UUID.equals(action)) {
            ...
            new AsyncTask<Void, Void, DataRadioStation>() {
                ...
                protected DataRadioStation doInBackground(Void... params) {
                    return com.lakshitasuman.musicstation.radio.Utils.getStationByUuid(httpClient, context, stationUUID);
                }
                ...
                protected void onPostExecute(DataRadioStation station) {
                    if (!isFinishing()) {
                        if (station != null) {
                            com.lakshitasuman.musicstation.radio.Utils.showPlaySelection(radioDroidApp, station, getSupportFragmentManager());

                            Fragment currentFragment = mFragmentManager.getFragments().get(mFragmentManager.getFragments().size() - 1);
                            if (currentFragment instanceof com.lakshitasuman.musicstation.radio.FragmentHistory) {
                                ((com.lakshitasuman.musicstation.radio.FragmentHistory) currentFragment).RefreshListGui();
                            }
                        }
                    }
                }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        mSearchView.setOnQueryTextFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                if (com.lakshitasuman.musicstation.radio.Utils.bottomNavigationEnabled(ActivityMain.this)) {
 ...
 */
    ...
    public void onFileSelected(FileDialog dialog, File file) {
        try {
            ...
            MainRadioHelper radioDroidApp = (MainRadioHelper) getApplication();
            com.lakshitasuman.musicstation.radio.FavouriteManager favouriteManager = radioDroidApp.getFavouriteManager();
            com.lakshitasuman.musicstation.radio.HistoryManager historyManager = radioDroidApp.getHistoryManager();
    ...
    void SaveFavourites() {
        ...
        dialog.setStyle(DialogFragment.STYLE_NO_TITLE, com.lakshitasuman.musicstation.radio.Utils.getThemeResId(this));
    ...
    void LoadFavourites() {
        ...
        dialogOpen.setStyle(DialogFragment.STYLE_NO_TITLE, com.lakshitasuman.musicstation.radio.Utils.getThemeResId(this));
    ...
    public boolean onOptionsItemSelected(MenuItem menuItem) {
        switch (menuItem.getItemId()) {
            ...
            case R.id.action_save:
                try {
                    if (com.lakshitasuman.musicstation.radio.Utils.verifyStoragePermissions(this, PERM_REQ_STORAGE_FAV_SAVE)) {
                        SaveFavourites();
                    }
                } catch (Exception exception) {
                    Log.e("MAIN", exception.toString());
            ...
            case R.id.action_load:
                try {
                    if (com.lakshitasuman.musicstation.radio.Utils.verifyStoragePermissions(this, PERM_REQ_STORAGE_FAV_LOAD)) {
                        LoadFavourites();
                    }
                } catch (Exception exception) {
                    Log.e("MAIN", exception.toString());
    ...
    private void setupStartUpFragment() {
        ...
        MainRadioHelper radioDroidApp = (MainRadioHelper) getApplication();
        com.lakshitasuman.musicstation.radio.HistoryManager hm = radioDroidApp.getHistoryManager();
        com.lakshitasuman.musicstation.radio.FavouriteManager fm = radioDroidApp.getFavouriteManager();
    ...
    public void Search(StationsFilter.SearchStyle searchStyle, String query) {
        ...
        Fragment currentFragment = mFragmentManager.getFragments().get(mFragmentManager.getFragments().size() - 1);
        if (currentFragment instanceof com.lakshitasuman.musicstation.radio.FragmentTabs) {
            ((com.lakshitasuman.musicstation.radio.FragmentTabs) currentFragment).Search(searchStyle, query);
        } else {
            String backStackTag = String.valueOf(R.id.nav_item_stations);
            com.lakshitasuman.musicstation.radio.FragmentTabs f = new com.lakshitasuman.musicstation.radio.FragmentTabs();
            FragmentTransaction fragmentTransaction = mFragmentManager.beginTransaction();
            if (com.lakshitasuman.musicstation.radio.Utils.bottomNavigationEnabled(this)) {
                fragmentTransaction.replace(R.id.containerView, f).commit();
        ...
        broadcastReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                if (intent.getAction().equals(ACTION_HIDE_LOADING)) {
                    ...
                    switch (playerType) {
                        case RADIODROID:
                            showMeteredConnectionDialog(() -> com.lakshitasuman.musicstation.radio.Utils.play((MainRadioHelper) getApplication(), PlayerServiceUtil.getCurrentStation()));
                            break;
                        case EXTERNAL:
