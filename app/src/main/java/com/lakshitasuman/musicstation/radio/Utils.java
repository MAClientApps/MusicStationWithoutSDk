...
import com.lakshitasuman.musicstation.radio.service.ConnectivityChecker;
...
import com.lakshitasuman.musicstation.radio.utils.Tls12SocketFactory;
...
public class Utils {
    ...
    public static String downloadFeedRelative(OkHttpClient httpClient, Context ctx, String theRelativeUri, boolean forceUpdate, Map<String, String> dictParams) {
        ...
        String currentServer = com.lakshitasuman.musicstation.radio.RadioBrowserServerManager.getCurrentServer();
        if (currentServer == null) {
            return null;
        }

        String endpoint = com.lakshitasuman.musicstation.radio.RadioBrowserServerManager.constructEndpoint(currentServer, theRelativeUri);
        ...
        String[] serverList = com.lakshitasuman.musicstation.radio.RadioBrowserServerManager.getServerList(false);
        ...
        for (String newServer : serverList) {
            ...
            endpoint = com.lakshitasuman.musicstation.radio.RadioBrowserServerManager.constructEndpoint(newServer, theRelativeUri);
            result = downloadFeed(httpClient, ctx, endpoint, forceUpdate, dictParams);
            if (result != null) {
                // set the working server as new current server
                com.lakshitasuman.musicstation.radio.RadioBrowserServerManager.setCurrentServer(newServer);
                return result;
            }
        }
