...
import com.lakshitasuman.musicstation.radio.interfaces.IAdapterRefreshable;
...
import com.lakshitasuman.musicstation.radio.utils.RecyclerItemMoveAndSwipeHelper;
...
import com.lakshitasuman.musicstation.radio.utils.RecyclerItemSwipeHelper;
import com.lakshitasuman.musicstation.radio.utils.SwipeableViewHolder;
...
public class ItemAdapterStation
    ...
    public void updateList(com.lakshitasuman.musicstation.radio.FragmentStarred refreshableList, List<DataRadioStation> stationsList) {
    ...
    public void onBindViewHolder(final StationViewHolder holder, int position) {
        ...
        Drawable flag = com.lakshitasuman.musicstation.radio.CountryFlagsLoader.getInstance().getFlag(activity, station.CountryCode);
